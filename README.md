...
WHAT YAPER DOES:
YAPER creates a universal group chat on your WiFi's IP address using UDP, allowing YAPER users to send and receive messages. This makes it ideal for communication between
